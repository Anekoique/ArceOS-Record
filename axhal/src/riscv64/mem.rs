use axconfig::{PAGE_SIZE, align_down, align_up, virt_to_phys};
...
pub fn kernel_image_regions() -> impl Iterator<Item = MemRegion> {
    [
        ...
        MemRegion {
            paddr: virt_to_phys(_sbss as usize),
